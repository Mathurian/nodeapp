...
export declare class RateLimitController {
    ...
    constructor();
    getAllConfigs: (_req: Request, res: Response, next: NextFunction) => Promise<Response | void>;
...
export declare const getAllConfigs: (_req: Request, res: Response, next: NextFunction) => Promise<Response | void>;
