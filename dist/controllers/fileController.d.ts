...
export declare class FileController {
    ...
    private prisma;
    constructor();
    listFiles: (req: Request, res: Response, next: NextFunction) => Promise<void | Response<import("../types/api/responses.types").SuccessResponse<{
        name: string;
        isDirectory: boolean;
        path: string;
    }[]>, Record<string, any>>>;
    downloadFile: (req: Request, res: Response, next: NextFunction) => Promise<void>;
    deleteFile: (req: Request, res: Response, next: NextFunction) => Promise<void | Response<import("../types/api/responses.types").SuccessResponse<any>, Record<string, any>>>;
    ...
    getFileStats: (_req: Request, res: Response, next: NextFunction) => Promise<Response | void>;
    upload: (req: Request, res: Response, next: NextFunction) => Promise<Response | void>;
}
export declare const listFiles: (req: Request, res: Response, next: NextFunction) => Promise<void | Response<import("../types/api/responses.types").SuccessResponse<{
    name: string;
    isDirectory: boolean;
    path: string;
}[]>, Record<string, any>>>;
export declare const downloadFile: (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const deleteFile: (req: Request, res: Response, next: NextFunction) => Promise<void | Response<import("../types/api/responses.types").SuccessResponse<any>, Record<string, any>>>;
...
export declare const getFileStats: (_req: Request, res: Response, next: NextFunction) => Promise<Response | void>;
