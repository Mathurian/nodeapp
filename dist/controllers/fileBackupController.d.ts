...
export declare class FileBackupController {
    ...
    private prisma;
    constructor();
    createBackup: (req: Request, res: Response, next: NextFunction) => Promise<Response<import("../types/api/responses.types").SuccessResponse<{
        success: boolean;
        backupPath: string;
        timestamp: string;
    }>, Record<string, any>>>;
    listBackups: (req: Request, res: Response, next: NextFunction) => Promise<Response<import("../types/api/responses.types").SuccessResponse<string[]>, Record<string, any>>>;
    deleteBackup: (req: Request, res: Response, next: NextFunction) => Promise<Response<import("../types/api/responses.types").SuccessResponse<any>, Record<string, any>>>;
...
export declare const createBackup: (req: Request, res: Response, next: NextFunction) => Promise<Response<import("../types/api/responses.types").SuccessResponse<{
    success: boolean;
    backupPath: string;
    timestamp: string;
}>, Record<string, any>>>;
export declare const listBackups: (req: Request, res: Response, next: NextFunction) => Promise<Response<import("../types/api/responses.types").SuccessResponse<string[]>, Record<string, any>>>;
export declare const deleteBackup: (req: Request, res: Response, next: NextFunction) => Promise<Response<import("../types/api/responses.types").SuccessResponse<any>, Record<string, any>>>;
