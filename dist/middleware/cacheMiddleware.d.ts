...
export declare const invalidateCache: (patterns: string | string[], namespace?: string) => (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const invalidateCacheTag: (tag: string | string[]) => (req: Request, res: Response, next: NextFunction) => Promise<void>;
...
declare const _default: {
    ...
    invalidateCache: (patterns: string | string[], namespace?: string) => (req: Request, res: Response, next: NextFunction) => Promise<void>;
    invalidateCacheTag: (tag: string | string[]) => (req: Request, res: Response, next: NextFunction) => Promise<void>;
