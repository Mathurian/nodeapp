            ...
            <div key={tenant.id} className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-lg shadow p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <button
                  ...
                  className={`w-full sm:flex-1 px-3 py-2 rounded-lg transition-colors text-sm ${
                    tenant.isActive
                ...
                {user?.role === 'SUPER_ADMIN' && (
                  <button
                    ...
                    className={`w-full sm:w-auto px-3 py-2 text-white rounded-lg transition-colors text-sm ${
