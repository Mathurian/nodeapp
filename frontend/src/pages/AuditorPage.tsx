...
const AuditorPage: React.FC = () => {
  ...
  const { data: stats, isLoading, error } = useQuery<AuditorStats>(
    'auditor-stats',
    async () => {
      const response = await auditorAPI.getStats()
      return response.data.data || response.data
    },
    {
      refetchInterval: 30000,
      retry: 1,
      onError: (err) => console.error('Auditor stats fetch failed:', err),
    }
  )
  ...
  const quickActions = [
    {
      ...
      href: '/auditor/pending-audits',
      icon: ClockIcon,
      color: 'blue',
      count: stats?.pendingAudits || 0
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700 rounded-lg p-6">
            <h2 className="text-lg font-semibold text-red-900 dark:text-red-100 mb-2">
              Error Loading Auditor Dashboard
            </h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900" data-testid="auditor">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" data-testid="auditor-dashboard">
        {/* Header */}
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Audit and review score certifications
          </p>
        </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-3xl font-bold mt-2 text-blue-900 dark:text-blue-100">
                    {isLoading ? '...' : stats?.pendingAudits || 0}
                  </p>
                </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-3xl font-bold mt-2 text-green-900 dark:text-green-100">
                    {isLoading ? '...' : stats?.completedAudits || 0}
                  </p>
                </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-3xl font-bold mt-2 text-orange-900 dark:text-orange-100">
                    {isLoading ? '...' : stats?.flaggedScores || 0}
                  </p>
                </div>
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-yellow-800 dark:text-yellow-200 mb-4">
                    You have {stats.pendingAudits} audit(s) requiring your attention.
                  </p>
                  <Link
                    to="/auditor/pending-audits"
