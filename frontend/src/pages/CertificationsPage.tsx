...
const CertificationsPage: React.FC = () => {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'EXPIRED':
        return <ClockIcon className="h-5 w-5 text-gray-600 dark:text-gray-400 dark:text-gray-500" />
      case 'SUSPENDED':
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {filteredCertifications.map((cert) => (
                    <tr key={cert.id} className="hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-700">
                      ...
                      <td className="px-6 py-4 text-sm whitespace-nowrap">
                        {cert.expiryDate ? (
                          ...
                          <span className="text-gray-500 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">No expiry</span>
                        )}
                      </td>
