...
export const NAV_SECTIONS: AppNavSection[] = [
  {
    ...
    items: [
      ...
      { id: 'search', name: 'Search', href: '/search', icon: MagnifyingGlassIcon, roles: ALL_ROLES, description: 'Search across application data', keywords: ['find', 'lookup'], shortcut: 'Cmd+/', priority: 80 },
