...
export const createQuickActionCommands = (options: {
  ...
  commands.push(
    {
      ...
      icon: UserPlusIcon,
      href: '/users?action=create&role=JUDGE',
    ...
    },
    {
      ...
      icon: UserPlusIcon,
      href: '/users?action=create&role=CONTESTANT',
  ...
  commands.push(
    ...
    },
    {
      ...
      icon: StarIcon,
      href: '/reports?type=certificates',
