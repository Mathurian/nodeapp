...
router.post('/:id/certify-tally', requireRole(['SUPER_ADMIN', 'ADMIN', 'ORGANIZER', 'TALLY_MASTER']), validate(idParamSchema, 'params'), logActivity('CERTIFY_TALLY', 'CERTIFICATION'), certifyTally)
...
router.post('/:id/approve-board', requireRole(['SUPER_ADMIN', 'ADMIN', 'ORGANIZER', 'BOARD']), validate(idParamSchema, 'params'), logActivity('APPROVE_BOARD', 'CERTIFICATION'), approveBoard)
