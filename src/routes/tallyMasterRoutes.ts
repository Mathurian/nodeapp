...
router.use(requireRole(['ADMIN', 'TALLY_MASTER', 'ORGANIZER', 'BOARD', 'AUDITOR']))
...
router.post('/score-removal-requests', requireRole(['ADMIN', 'ORGANIZER', 'TALLY_MASTER', 'AUDITOR', 'BOARD']), logActivity('REQUEST_SCORE_REMOVAL', 'SCORE_REMOVAL'), requestScoreRemoval)
router.get('/score-removal-requests', requireRole(['ADMIN', 'ORGANIZER', 'TALLY_MASTER', 'AUDITOR', 'BOARD']), getScoreRemovalRequests)
router.post('/score-removal-requests/:id/approve', requireRole(['ADMIN', 'ORGANIZER', 'BOARD']), logActivity('APPROVE_SCORE_REMOVAL', 'SCORE_REMOVAL'), approveScoreRemoval)
router.post('/score-removal-requests/:id/reject', requireRole(['ADMIN', 'ORGANIZER', 'BOARD']), logActivity('REJECT_SCORE_REMOVAL', 'SCORE_REMOVAL'), rejectScoreRemoval)

// Score drill-down routes
router.get('/scores/contestant', requireRole(['ADMIN', 'TALLY_MASTER', 'AUDITOR', 'BOARD']), getContestantScores)
router.get('/scores/judge', requireRole(['ADMIN', 'TALLY_MASTER', 'AUDITOR', 'BOARD']), getJudgeScores)
router.get('/category/:categoryId/judges', requireRole(['ADMIN', 'TALLY_MASTER', 'AUDITOR', 'BOARD']), getCategoryJudges)
router.delete('/scores/remove', requireRole(['ADMIN', 'TALLY_MASTER', 'AUDITOR', 'BOARD']), logActivity('REMOVE_JUDGE_CONTESTANT_SCORES', 'SCORE'), removeJudgeContestantScores)
