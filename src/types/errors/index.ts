...
export enum ErrorCode {
  ...
  TELEMETRY_QUOTA_EXCEEDED = 'TELEMETRY_QUOTA_EXCEEDED',

  // Bad request (400)
  BAD_REQUEST = 'BAD_REQUEST',
  IDEMPOTENCY_REQUIRED = 'IDEMPOTENCY_REQUIRED',
  TELEMETRY_INVALID_PAYLOAD = 'TELEMETRY_INVALID_PAYLOAD',
  TELEMETRY_STALE_EVENT = 'TELEMETRY_STALE_EVENT',
  ...
  IDEMPOTENCY_AUTH_EXPIRED_RETRYABLE = 'IDEMPOTENCY_AUTH_EXPIRED_RETRYABLE',
